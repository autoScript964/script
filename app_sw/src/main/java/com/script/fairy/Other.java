        ...
        while (mFairy.condit()) {
            ...
            if (bj == 0) {
                ...
                if (ditu == 1) {
                    ...
                    gamePublicFunction.BackCity(483, 555, "清河镇");
                } else if (ditu == 6) {
                    gamePublicFunction.BackCity(854, 344, "长安巷");
                }
                js_1 = 0;
                js_2 = 0;
                js_3 = 0;
            ...
            if (bj == 3) {
                ...
                result = mFairy.findPic(68, 11, 234, 73, "ao.png");

                LtLog.e(commonFunction.getLineInfo(result, 0.7f, "长安巷"));
                commonFunction.RndCompare(0.7f, result.x + 10, result.y + 10, result, commonFunction.getImg());
                Thread.sleep(1000);
                commonFunction.RndCompare(0.7f, 680, 367, result, commonFunction.getImg());
                commonFunction.RndCompare(0.7f, 1152, 90, result, commonFunction.getImg());
                Thread.sleep(3000);
                bj = 4;
            }
            if (bj == 4) {
    ...
    public void ZhuoGuiMaiQ() throws Exception {
        ...
        while (mFairy.condit()) {
            ...
            if (bj == 1) {
                ...
                if (result.sim > 0.8) {
                    for (int i = 0; i < 3; i++) {
                        ...
                        mFairy.touchMove(2, 793, 264, 2000);
                        mFairy.touchUp(2);
                    }
                }
            }
            if (bj == 2) {
                ...
                LtLog.e(commonFunction.getLineInfo(result, 0.8f, "打怪双倍界面"));
                if (result.sim > 0.8) {
                    result = mFairy.findPic2(161,396,1064,481, commonFunction.setImg(string));
