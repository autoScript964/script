...
public abstract class TaskContent {
    ...
    Slide activitySlide = new TaskContent.Slide(956,160,989,443);
    Slide taskSlide = new TaskContent.Slide(92,95,116,215);
    Slide rankmbSlide = new TaskContent.Slide(298,243,340,492);
    Slide ytdgSlide = new TaskContent.Slide(364,211,398,396);
    ...
    void create() throws Exception {
        taskSlide.set_slideRangeIndex_init(74,198,98,351);
    }
