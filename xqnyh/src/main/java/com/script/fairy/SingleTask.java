...
public class SingleTask extends TaskContent {
    ...
    public void zongmen() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                int ret = gameUtil.mission("zongmen.png", 2);
                if (ret == 0) {
                    setTaskEnd();
                    return;
                } else if (ret == 1) {
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic(33, 190, 71, 461, new String[]{"zongmen1.png", "zongmen5.png"});
                LtLog.i(mFairy.getLineInfo("左侧宗门sim：" + result.sim));
                if (result.sim > 0.7f) {
                    mFairy.onTap(0.7f, result, "左侧宗门", 2500);
                    smcount = 0;
                    task_err = 0;
                    setTaskName(3);
                    return;
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic(990, 99, 1170, 700, new String[]{"zongmen2.png"});
                mFairy.onTap(0.8f, result, "右侧师门", 2000);
                if (result.sim > 0.8f) {
                    err = 0;
                    mFairy.initMatTime();
                } else {
                    result = mFairy.findPic(1266, 685, 1131, 195, new String[]{"zongmen3.png"});
                    if (result.sim > 0.8f) {
                        mFairy.onTap(0.8f, result, "宗门事务", 2000);
                        dazeTime = 10;
                    }
                }
                ...
                result = mFairy.findPic(new String[]{"Handin.png", "Handin1.png"});
                if (result.sim > 0.8f) {
                    err = 0;
                ...
                result = mFairy.findPic(957, 375, 1143, 481, "zongmen4.png");
                mFairy.onTap(0.8f, result, 1146, 281, 1162, 300, "宗门云浮", 1000);
                if (result.sim > 0.8f) {
                    smcount = 0;
                    setTaskName(0);
                    return;
                ...
                mFairy.onTap(0.8f, result, "对话", 2000);
                ...
                if (dazeTime > 4) {
                    result = mFairy.findPic(33, 190, 71, 461, new String[]{"zongmen1.png", "zongmen7.png"});
                    mFairy.onTap(0.7f, result, "左侧宗门", 2500);
                    if (result.sim > 0.7f) {
                        smcount = 0;
                    }
    ...
    public void novice() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_0() throws Exception {
                ...
                result = mFairy.findPic(755,525,892,616,"nn8.png");
                if (result.sim > 0.8f) {
                    mFairy.onTap(1145,576,1156,584,"释放技能",1500);
                }


                result = mFairy.findPic(new String[]{"gj.png","gj1.png"});
                if (result.sim > 0.8f) {
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(289, 614, 392, 678, "nn7.png");
                mFairy.onTap(0.8f, result, 789, 481, 804, 488, "新手对话", Sleep);
                ...
                if (other) {
                    ...
                    if (result.sim > 0.8f) {
                       ...
                       *//* sslCount++;
                        ...
                        mFairy.onTap(0.8f, result, 1234, 195, 1248, 211, "打开伸缩栏", 1000);
                    }
*/
                    ...
                    result = mFairy.findPic("baoguo.png");
                    if (result.sim > 0.7f) {


                        result = mFairy.findPic(334, 133, 786, 192, "nn5.png");
                        if (result.sim > 0.7f) {
                            mFairy.tap(result.x + 300, 172);
                            Thread.sleep(1500);
                        }


                        result = mFairy.findPic(294, 130, 811, 185, "zyother5.png");
                        if (result.sim > 0.7f) {
                            mFairy.tap(result.x + 253, 201);
                            Thread.sleep(1500);
                        }

                        result = mFairy.findPic(302, 238, 684, 410, "zhuangbei2.png");
                        mFairy.onTap(0.7f, result, "装备药", 20000);

                        result = mFairy.findPic(765, 91, 1189, 199, "zhuangbei3.png");
                        mFairy.onTap(0.7f, result, "装备武器", 20000);
                ...
                result = mFairy.findPic(661, 420, 923, 562, new String[]{"yao.png", "yao1.png"});
                if (result.sim > 0.7f) {
                    mFairy.onTap(410, 255, 425, 267, "", 500);
                    mFairy.onTap(184, 206, 261, 239, "", 500);
                    mFairy.onTap(406, 407, 421, 424, "", 500);
                    mFairy.onTap(184, 206, 261, 239, "", 500);
                }
            ...
            public void inOperation() throws Exception {
                ...
                mFairy.onTap(0.8f, result, result.x - 300, result.y + 10, result.x - 280, result.y + 20, "选择手套", 3000);
    ...
    public void master() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic(813, 97, 1275, 709, new String[]{"Tailor.png", "Blacksmith.png", "Drugstore.png", "zahuopu.png"});
                if(result.sim>0.8f) {
                    mFairy.onTap(0.8f, result, "右侧npc铺子", 5000);
                    dazeTime=0;
                    mFairy.initMatTime();
                }
    ...
    public void master1() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic(813, 97, 1275, 709, "shimen2.png");
                if (result.sim > 0.8f) {
                ...
                if (dazeTime > 8) {
                    ...
                    if (result.sim > 0.7f) {
                        ...
                        if (err != 0 && err % 3 == 0) {
                            mFairy.onTap(597, 343, 613, 387, "", 2000);
                        }
                    }
                } else {
                    err = 0;
        ...
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    result = mFairy.findPic(new String[]{"plotover.png", "plotover1.png"});
                    if (result.sim > 0.75f) {
            ...
            public void content_4() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    if (jqdj > 5 && jqdj <= 10) {
                        mFairy.onTap(199, 192, 227, 196, "35-55等级范围", Sleep);
                    }
                    if (jqdj > 10 && jqdj <= 15) {
                        mFairy.onTap(190, 217, 216, 221, "60-80等级范围", Sleep);
                    }
                    if (jqdj > 15 && jqdj <= 20) {
                        mFairy.onTap(202, 242, 232, 248, "85-105等级范围", Sleep);
                    }
                    if (jqdj > 20 && jqdj <= 25) {
                        mFairy.onTap(205, 271, 235, 275, "110-130等级范围", Sleep);
                    }
                    if (jqdj > 25 && jqdj <= 30) {
                        mFairy.onTap(204, 291, 236, 298, "135-150等级范围", Sleep);
                    }
            ...
            public void content_5() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    if (type == 3) {
                        mFairy.onTap(660, 525, 666, 534, "重温", Sleep);
                    }
                    if (type == 4) {
                        mFairy.onTap(843, 509, 849, 515, "重温", Sleep);
                    }
                    if (type == 5) {
                        mFairy.onTap(1033, 506, 1039, 521, "重温", Sleep);
                    }
                    Thread.sleep(5000);
        ...
        new SingleTask(mFairy) {
            ...
            public void content_0() throws Exception {
                if (AtFairyConfig.getOption("opcount1").equals("")) {
                    ...
                    LtLog.e(mFairy.getLineInfo("jqdj:" + jqdj));
                    LtLog.e(mFairy.getLineInfo("jqdj1:" + jqdj1));
                }
                gameUtil.close(0);
                setTaskName(1);
            }
            ...
            public void content_7() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    if (jqdj == 4) {
                        mFairy.onTap(841, 506, 848, 522, "重温", Sleep);
                    }
                    if (jqdj == 5) {
                        mFairy.onTap(1023, 512, 1033, 525, "重温", Sleep);
                    }
                    Thread.sleep(5000);
                }
                result = mFairy.findPic(373, 203, 906, 483, "Copydetermination.png");
    ...
    public void lsroutine() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic("Handin.png");
                LtLog.e(mFairy.getLineInfo(0.8f, result, "上交"));
                if (result.sim > 0.8f) {
                    LtLog.e(mFairy.getLineInfo("上交"));
                    Thread.sleep(5000);
    ...
    public void war() throws Exception {
        ...
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic(new String[]{"Giveuptask.png", "Giveuptask1.png", "fangqi.png"});
                mFairy.onTap(0.75f, result, "任务失败放弃", 5000);
    ...
    public void rankingList() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                mFairy.onTap(0.8f, result, "排行榜", 5000);

                result = mFairy.findPic(13, 41, 216, 598, "grxx.png");
                mFairy.onTap(0.95f, result, "个人信息", 5000);

                result = mFairy.findPic(2,49,206,250, "Rankingsinterface.png");
                if (result.sim > 0.8f) {
                    err = 0;
            ...
            public void content_2() throws Exception {
                ...
                if (result.sim > 0.8f && bjcount == 0) {
                   ...
                   /* result = mFairy.findPic(1050, 46, 1126, 112, new String[]{"fork1.png", "fork2.png", "fork3.png", "fork4.png"});
                    ...
                    //728, 348, 800, 500
                    LtLog.e(mFairy.getLineInfo("排行榜界面"));//728, 262, 800, 327
                    mFairy.onTap(728, x, 729, x + 1, "选个角色", 2000);
                    x = x + 65;
                    if (x > 660) {
                        bjcount = 0;
                        x = 262;
                ...
                if (bjcount == 1) {
                    ...
                    mFairy.onTap(0.8f, result, "梦岛", 10000);
                    if (result.sim > 0.8f) {
                        err = 0;
                    }
                    result = mFairy.findPic(307, 65, 1249, 704, "Woo.png");
                    mFairy.onTap(0.8f, result, "踩一踩", 2000);
                    mFairy.onTap(0.8f, result, 1181, 55, 1187, 62, "踩完了关闭下一个", 5000);
                    if (result.sim > 0.8f) {
                        bjcount = 0;
                        err = 0;
                    }
    ...
    public void switchedRoles() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                mFairy.onTap(0.8f, result, "切换角色", 5000);
