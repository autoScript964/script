...
public class test {
    ...
    public static List<Match> fastTemplateMatching(Mat img, Mat template, int matchMethod, float weakThreshold, float strictThreshold, int maxLevel, int limit) {
        ...
        if (maxLevel == MAX_LEVEL_AUTO) {
            ...
            System.out.println("======selectPyramidLevel:" + maxLevel);
        }
        ...
        for (int level = maxLevel; level >= 0; level--) {
            // 放缩图片
            System.out.println("======match:" + maxLevel);
...
//                OpenCVHelper.release(src);
            ...
            System.out.println("level:" + level + ", result:" + previousMatchResult);
        ...
        System.out.println("======result:" + finalMatchResult);
